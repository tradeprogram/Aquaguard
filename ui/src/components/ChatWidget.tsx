        ...
        <div className="flex h-[36rem] max-h-[85vh] w-[30rem] max-w-[90vw] flex-col overflow-hidden rounded-2xl border border-white/10 bg-slate-900/40 shadow-2xl backdrop-blur-xl">
          ...
          <div className="flex items-center gap-2 border-t border-white/10 bg-slate-950/20 px-3 py-3 backdrop-blur-xl">
            ...
            <button
              ...
              disabled={sending}
              aria-label="메시지 전송"
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-sky-300/20 bg-sky-500/70 text-white shadow-md backdrop-blur-sm transition-transform hover:scale-105 hover:bg-sky-400/80 disabled:opacity-50"
            >
