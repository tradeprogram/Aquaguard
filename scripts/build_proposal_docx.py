...
def write(D: Doc) -> None:
    ...
    D.table(
        ["트랙", "담당", "소유 모듈", "핵심 산출물"],
        [
            ("① 예측모델·위성·검증", "김민석", "A, B, V", "산사태·홍수 폴리곤, Sentinel-1 검증, dNBR 증폭계수"),
            ("② 대응로직·데이터통합", "나정우", "C, D, G, H", "도로침수 규칙엔진, 노출자산, 피해비용, 시민 역검증"),
            ("③ 오케스트레이션·UI·3D", "하수범", "O, UI", "상태머신·경보 전파, 3D 대시보드, 통합·데모 총괄"),
